  ...
  return (
    <main className="bg-[#0a0a0a] min-h-dvh">
      ...
      <header className="px-5 md:px-10 pt-16 md:pt-24 pb-10">
        <Link
          href="/jugadores"
          className="font-mono text-[10px] tracking-[0.15em] uppercase text-white/65 no-underline hover:text-white/75 transition-colors"
        >
          ← Todos los jugadores
        </Link>
        <h1
        ...
        {profile.bio && (
          <p className="mt-6 max-w-[560px] text-[15px] font-light leading-[1.8] text-white/85">
            {profile.bio}
          </p>
        )}
      </header>
      ...
      <section className="px-5 md:px-10 pb-24">
        <div className="bio-cell px-8 py-9 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <p className="mt-2 text-[14px] text-white/80 font-light leading-[1.7] max-w-[440px]">
