    ...
    <footer className="bg-[#0a0a0a] border-t border-white/[0.07] px-5 md:px-10 pt-14 pb-7">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-10">
        <div>
          ...
          <p className="mt-3 max-w-[340px] text-[15px] text-white/70 leading-[1.7]">
          ...
          <div className="flex flex-col gap-2.5">
            {NAV.map((l) => (
              <Link
                key={l.href}
                href={l.href}
                className="font-mono text-[12px] tracking-[0.12em] text-white/75 uppercase no-underline hover:text-[#e8ff00] transition-colors"
              >
                {l.label}
              </Link>
            ))}
      ...
      <div className="mt-12 pt-6 border-t border-white/[0.05] flex flex-col md:flex-row gap-2 md:items-center justify-between">
        <span className="font-mono text-[12px] tracking-[0.12em] text-white/55 uppercase">
