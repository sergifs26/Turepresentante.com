...
export default function WhatsappPill() {
  ...
  return (
    <a
      ...
      className="bio-btn fixed bottom-5 right-5 z-40 flex items-center md:gap-2.5 bg-[#0f0f0f] border border-[#e8ff00]/35 text-[#f0f0ee] font-mono text-[12px] tracking-[0.12em] uppercase p-3.5 md:px-5 md:py-3 no-underline shadow-[0_4px_24px_rgba(0,0,0,0.5)]"
    >
      <svg width="20" height="20" viewBox="0 0 24 24" fill="#e8ff00" aria-hidden="true" className="md:w-4 md:h-4">
      ...
      {/* En móvil solo la bolita: el texto tapaba botones y formularios */}
      <span className="hidden md:inline">¿Dudas? Escríbenos</span>
    </a>
  );
}
