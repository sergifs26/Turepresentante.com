...
export default function WhatsappPill() {
  ...
  return (
    <a
      ...
      className="bio-btn fixed bottom-5 right-5 z-40 flex items-center gap-2.5 bg-[#0f0f0f] border border-[#e8ff00]/35 text-[#f0f0ee] font-mono text-[10px] tracking-[0.12em] uppercase px-5 py-3 no-underline shadow-[0_4px_24px_rgba(0,0,0,0.5)]"
    >
